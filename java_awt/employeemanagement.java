...
class multithreading implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      while (true) {
    moving.setBounds(150,560,150,20);
    Thread.sleep(700);
    moving.setBounds(300,560,150,20);
    Thread.sleep(700);
    moving.setBounds(450,560,150,20);
    Thread.sleep(700);
    moving.setBounds(550,560,150,20);
    Thread.sleep(00);
      }
    }
...
{   
  ...
  ArrayList<temporaryemployee> arrayList$Temporaryemployees=new ArrayList<>();
   ...
   employeemanagement()
  {
    ...
    hi$l=new JLabel("employee management");
    hi$l.setBounds(20,560,70,20);
    ...
    add(permanent$b);add(temparory$b);add(hi$l);
